...
// *
// */
//public class CalendarDrawer extends JPanel {
//
...
//
//    double wPdfmm = 297., hPdfmm = 210.;
//    double mmToPx = 841.8898 / wPdfmm; // 2.83480453972;
//    double pxTomm = 1. / mmToPx;
//    float wPdf = 841.8898f, hPdf = 595.27563f;
//    float bleedPdf = (float) (3 * mmToPx);
//    double wh_ratio = wPdfmm / hPdfmm;
//
//    // Dessin (pour conserver les polices
//    double width = 1124;  // 297*mmToPx; =  842   /1.33
//    double height = width / wh_ratio; // 800; // 210*mmToPx; =  595
//    double bleedBorder = bleedPdf * (width / wPdf);
//
...
//            withBackground = true;
//
//    public CalendarDrawer(int year) {
//        super();
//
//        this.calendar = new CalendarCalculator2024(1.5340268, 43.315025); // calendrette // 1.444209, 43.604652);  // Toulouse);
...
//            Logger.getLogger(CalendarDrawer.class.getName()).log(Level.SEVERE, null, ex);
//        }
//    }
//
//    public static JComponent generateCalendarUI(final int year) {
//        CalendarDrawer textArea1 = new CalendarDrawer(year);
//
//        return textArea1;
//    }
//
...
//        return new Dimension((int) width + 20, (int) (height + 20) * 12);
//    }
//
//    @Override
...
//        return new Dimension((int) width + 100, (int) (height + 20) * 12);
//    }
//
...
//        if (withHollidays) {
//            int yv = (int) (y + h) - 8;
//            if (di.inHoliday[2]) {//isInPeriod(lstHolidays_C, date)) {
...
//        if (withFeriesTxt) {
//            if (di.ferie != null) {
//                drawInfo(di.ferie, g2, x, y, h);
//            } else {
//                drawInfo(di.info, g2, x, y, h);
//            }
//        }
//
//        // numero du jour
...
//
//        for (int month = 0; month < 12; month++) {
//            g2.setClip(new Rectangle2D.Double(0, 0, width + bleedBorder * 2, height + bleedBorder * 2));
//            paintMonth(g2, month, width, height, bleedBorder);
//            g2.translate(0, height + 20 + 2. * bleedBorder);
//        }
//    }
//
...
//    }
//
//    public void renderToPdf(int month) throws IOException {
////396,5 * 282,2 mm
//
//// image : 297/210
//// calendrier : 396.5/282.2;
//// bleed 
//        try (PDDocument document = new PDDocument()) {
//            PDDocumentInformation pdd = document.getDocumentInformation();
//            pdd.setTitle("Calendoc 2022 " + monthNames[month]);
//            // 297./210.
//
//            // 301.5mm x 214.5mm
//            // A4  841.8898, 595.27563
//            PDPage page = new PDPage(new PDRectangle(wPdf + bleedPdf * 2, hPdf + bleedPdf * 2));
//            page.setMediaBox(new PDRectangle(wPdf + bleedPdf * 2, hPdf + bleedPdf * 2));
////            page.setBleedBox(new PDRectangle(bleedPdf,bleedPdf,wPdf,hPdf));
//            page.setTrimBox(new PDRectangle(bleedPdf, bleedPdf, wPdf, hPdf));
//            document.addPage(page);
//
//            PdfBoxGraphics2D pdfBoxGraphics2D = new PdfBoxGraphics2D(document, wPdf + bleedPdf * 2, hPdf + bleedPdf * 2);
//
//            pdfBoxGraphics2D.scale(wPdf / width, hPdf / height);
//            this.paintMonth(pdfBoxGraphics2D, month, width, height, bleedBorder);
//
...
//            contentStream.close();
//
//            document.save(new File("C:\\Users\\sebastien.durand\\Desktop\\Calendoc\\" + (month + 1) + "_" + monthNames[month] + ".pdf"));
//        }
//    }
//
