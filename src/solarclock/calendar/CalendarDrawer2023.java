 ...
 *
 */
public class CalendarDrawer2023 extends JPanel {
    ...
    private final String[] lstUrl = {
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-01/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-02/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-03/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-04/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-05/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-06/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-07/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-08/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-09/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-10/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-11/",
        "https://calandreta-del-pais-sud-tolosan.webnode.fr/calandoc-2023-12/"
    };

    private final static Color[] monthColors = {
        new Color(32, 127, 219), // janvier Dame Carcasse
        new Color(246, 203, 109), // fev
        new Color(127, 56, 38), // maars  Drac
        new Color(114, 177, 207), // abril  jean de l'ours
        new Color(178, 192, 45), // mai  Pimpounet
        new Color(237, 209, 123), // juin (tarasque)
        new Color(126, 185, 227), // juillet  volo biou
        new Color(72, 105, 185), // aout pont du diable
        new Color(226, 217, 119), // sept  Marseille
        new Color(191, 89, 48), // oct  gevaudan
        new Color(87, 142, 199), // nov  etan de thau
        new Color(69, 90, 150) // dec  loupgarrou
    };
    ...
    public static Shape createOccitranCrossPath() {
        ...
        final Path2D path = SimpleSvgTools.svgPathToPath2D(pathSvg);
        final double r = 18;
        final double[] pos = {
        ...
        final Area aera = new Area(path);
        for (int i = 0; i < 12; i++) {
            aera.add(new Area(new Ellipse2D.Double(pos[i * 2] - r, pos[i * 2 + 1] - r, r * 2, r * 2)));
        }
        return aera;
    }
    ...
    Color colorMonthBackground = Color.white;
    Color colorMonth = Color.black;
    Font fontMonth = new Font("ParmaPetit", Font.PLAIN, 140);
    int monthx = 20, monthy = (int) hTop - 10;

    float epLine = 2.f;
    Color colorLine = Color.black;

    float epWeekLine = 1.f;
    Color colorWeekLine = Color.gray;

    Color colorDayName = Color.black;
    ...
    Color colorColumnDay = Color.black;
    float epColumnDay = 2.f;

    // Configuration dessin jour
    Color colorBackground = new Color(255, 255, 255, 150);
    Color colorFerie = new Color(100, 100, 255, 16);

    // Nuerao du jour
    Color colorDay = Color.black;
    Font fontDay = new Font("ParmaPetit", Font.PLAIN, 26);
    int dxDay = 18;
    int dyDay = 18;
    ...
    Font colorFont = new Font("ParmaPetit", Font.PLAIN, 16);
    ...
    public CalendarDrawer2023() {
        super();

        CalendarGeneration.registerAllFonts();

        this.calendar = new CalendarCalculator2023(1.5340268, 43.315025); // calendrette // 1.444209, 43.604652);  // Toulouse);
    }

    public static JComponent generateCalendarUI(final int year) {
        CalendarDrawer2023 textArea1 = new CalendarDrawer2023();
        return textArea1;
    }
...
//            String txt =  String.format("%02d:%02d-%02d:%02d", up.getHourOfDay(),up.getMinuteOfHour(),down.getHourOfDay(),down.getMinuteOfHour());
            ...
            //g2.drawString(txt2, (int) x + 40, (int) (y + 25));
    ...
    public void paintMonth(Graphics2D g2, int month, double w, double h, double border) {
        ...
        paintMonthBackground(g2, w, h, 0/*bleedBorder*/, month);
        ...
        g2.drawString(monthNames[month], monthx, monthy);

        double qrsz = hTop - 30;
        drawQRCode(g2, lstUrl[month], w - qrsz - 20, 20, qrsz, qrsz);
        g2.drawImage(CalendarCalculator.imgSpeaker, (int) (w - qrsz) - 70, 20 + (int) (qrsz / 2) - 15, 30, 30, null);
    ...
    private static ByteMatrix generateMatrix(final String data) {
        try {
            ...
            Logger.getLogger(CalendarDrawer2023.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    private void paintMonthBackground(Graphics2D g2, double w, double h, double border, int month) {
        ...
        // entete month
        g2.setColor(colorMonthBackground);
