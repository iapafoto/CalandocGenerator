 ...
 *
 */
public class CalendarDrawer2024 extends JPanel {
    ...
    private final String[] lstUrl = {
        BASE_URL + "calandoc-2024-01/",
        BASE_URL + "calandoc-2024-02/",
        BASE_URL + "calandoc-2024-03/",
        BASE_URL + "calandoc-2024-04/",
        BASE_URL + "calandoc-2024-05/",
        BASE_URL + "calandoc-2024-06/",
        BASE_URL + "calandoc-2024-07/",
        BASE_URL + "calandoc-2024-08/",
        BASE_URL + "calandoc-2024-09/",
        BASE_URL + "calandoc-2024-10/",
        BASE_URL + "calandoc-2024-11/",
        BASE_URL + "calandoc-2024-12/"
    };

    public final static Color[] monthColors = {
        new Color(0x74C3B0), // janvier Dame Carcasse
        new Color(0xFEBE8E), // fev
        new Color(0x859AD1), // maars  Drac
        new Color(0xC1C5EA), // abril  jean de l'ours
        new Color(0xFFA2AC), // mai  Pimpounet
        new Color(0xFE929F), // juin (tarasque)
        new Color(0xC6E9FF), // juillet  volo biou
        new Color(0x99D8FF), // aout pont du diable
        new Color(0xFEC2DB), // sept  Marseille
        new Color(0xFFA8C0), // oct  gevaudan
        new Color(0xFEA887), // nov  etan de thau
        new Color(0xFFD07E) // dec  loupgarrou
    };
    ...
    Color colorMonth = alpha(Color.black, .5);
    Font fontMonth = new Font("ParmaPetit", Font.PLAIN, 120);
    ...
    Color colorDayName = alpha(Color.black, .25);
    ...
    public static JComponent generateCalendarUI(final int year) {
        CalendarDrawer2024 textArea1 = new CalendarDrawer2024();
        return textArea1;
    }
...
//            String txt =  String.format("%02d:%02d-%02d:%02d", up.getHourOfDay(),up.getMinuteOfHour(),down.getHourOfDay(),down.getMinuteOfHour());
    ...
    //    g2.drawString(monthNames[month], monthx, monthy);
        DrawTools.drawStringCenter(g2, monthNames[month], (w- qrsz - 20)/2, monthy-27);
    ...
    private static ByteMatrix generateMatrix(final String data) {
        try {
            ...
            Logger.getLogger(CalendarDrawer2024.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    private void paintMonthBackground(Graphics2D g2, double w, double h, double border, int month) {
       // g2.setClip(new Rectangle2D.Double(0, 0, w + border * 2, h + border * 2));
        // entete month
        g2.setColor(mix(monthColors[month], Color.white,.85));
